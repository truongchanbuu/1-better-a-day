...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(selection, percentageValue) =>
      "${Intl.select(selection, {'positive': '+${percentageValue}% so với tuần trước', 'negative': '-${percentageValue}% so với tuần trước', 'neutral': 'Không thay đổi kể từ tuần trước', 'other': 'Không thay đổi kể từ tuần trước'})}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "achievable_title": MessageLookupByLibrary.simpleMessage(
      "Đạt được - Achievable",
    ),
    "achieved": m0,
    "achieved_habit": MessageLookupByLibrary.simpleMessage(
      "Các thói quen đã đạt được",
    ),
    "achieved_statistic_page": MessageLookupByLibrary.simpleMessage(
      "Đã đạt được",
    ),
    ...
    "achievements_screen": MessageLookupByLibrary.simpleMessage("Thành tựu"),
    "action_creative_build": MessageLookupByLibrary.simpleMessage("xây dựng"),
    "action_creative_compose": MessageLookupByLibrary.simpleMessage("sáng tác"),
    "action_creative_create": MessageLookupByLibrary.simpleMessage("tạo ra"),
    "action_creative_design": MessageLookupByLibrary.simpleMessage("thiết kế"),
    "action_creative_develop": MessageLookupByLibrary.simpleMessage(
      "phát triển",
    ),
    ...
    "action_exercise_gym": MessageLookupByLibrary.simpleMessage(
      "đến phòng tập",
    ),
    ...
    "action_exercise_stretch": MessageLookupByLibrary.simpleMessage("giãn cơ"),
    ...
    "action_exercise_workout": MessageLookupByLibrary.simpleMessage(
      "tập luyện",
    ),
    "action_exercise_yoga": MessageLookupByLibrary.simpleMessage("tập yoga"),
    ...
    "action_improvement_decrease": MessageLookupByLibrary.simpleMessage("giảm"),
    "action_improvement_enhance": MessageLookupByLibrary.simpleMessage(
      "nâng cao",
    ),
    "action_improvement_improve": MessageLookupByLibrary.simpleMessage(
      "cải thiện",
    ),
    "action_improvement_increase": MessageLookupByLibrary.simpleMessage("tăng"),
    "action_improvement_optimize": MessageLookupByLibrary.simpleMessage(
      "tối ưu hóa",
    ),
    "action_improvement_reduce": MessageLookupByLibrary.simpleMessage(
      "giảm thiểu",
    ),
    "action_improvement_upgrade": MessageLookupByLibrary.simpleMessage(
      "nâng cấp",
    ),
    "action_learning_learn": MessageLookupByLibrary.simpleMessage("học hỏi"),
    "action_learning_master": MessageLookupByLibrary.simpleMessage(
      "thành thạo",
    ),
    "action_learning_practice": MessageLookupByLibrary.simpleMessage(
      "thực hành",
    ),
    "action_learning_read": MessageLookupByLibrary.simpleMessage("đọc"),
    "action_learning_research": MessageLookupByLibrary.simpleMessage(
      "nghiên cứu",
    ),
    "action_learning_revise": MessageLookupByLibrary.simpleMessage("ôn tập"),
    ...
    "action_productivity_accomplish": MessageLookupByLibrary.simpleMessage(
      "thực hiện",
    ),
    "action_productivity_achieve": MessageLookupByLibrary.simpleMessage(
      "đạt được",
    ),
    "action_productivity_complete": MessageLookupByLibrary.simpleMessage(
      "hoàn thành",
    ),
    "action_productivity_continue": MessageLookupByLibrary.simpleMessage(
      "tiếp tục",
    ),
    "action_productivity_do": MessageLookupByLibrary.simpleMessage("làm"),
    "action_productivity_finish": MessageLookupByLibrary.simpleMessage(
      "kết thúc",
    ),
    "action_productivity_start": MessageLookupByLibrary.simpleMessage(
      "bắt đầu",
    ),
    "action_productivity_work": MessageLookupByLibrary.simpleMessage(
      "làm việc về",
    ),
    "action_social_call": MessageLookupByLibrary.simpleMessage("gọi điện"),
    "action_social_connect": MessageLookupByLibrary.simpleMessage(
      "kết nối với",
    ),
    "action_social_email": MessageLookupByLibrary.simpleMessage("gửi email"),
    ...
    "action_social_spend": MessageLookupByLibrary.simpleMessage(
      "dành thời gian với",
    ),
    ...
    "action_time_plan": MessageLookupByLibrary.simpleMessage("lập kế hoạch"),
    "action_time_schedule": MessageLookupByLibrary.simpleMessage("lên lịch"),
    "action_time_spend": MessageLookupByLibrary.simpleMessage("dành"),
    "action_tracking_analyze": MessageLookupByLibrary.simpleMessage(
      "phân tích",
    ),
    ...
    "action_tracking_measure": MessageLookupByLibrary.simpleMessage("đo lường"),
    "action_tracking_monitor": MessageLookupByLibrary.simpleMessage("giám sát"),
    "action_tracking_record": MessageLookupByLibrary.simpleMessage("ghi lại"),
    "action_tracking_track": MessageLookupByLibrary.simpleMessage("theo dõi"),
    ...
    "active_statistic_page": MessageLookupByLibrary.simpleMessage(
      "Đang thực hiện",
    ),
    ...
    "add_habit_manually": MessageLookupByLibrary.simpleMessage(
      "Tự tạo thói quen",
    ),
    ...
    "add_reminder": MessageLookupByLibrary.simpleMessage("Thêm lịch nhắc nhở"),
    ...
    "afternoon_greeting": MessageLookupByLibrary.simpleMessage(
      "Chào buổi trưa",
    ),
    ...
    "all_detail_history": MessageLookupByLibrary.simpleMessage(
      "Chi tiết các lịch sử",
    ),
    ...
    "attendance_button": MessageLookupByLibrary.simpleMessage(
      "Tham gia thử thách",
    ),
    "authentication_choice": MessageLookupByLibrary.simpleMessage(
      "Đăng nhập/Đăng ký",
    ),
    "author_aristotle": MessageLookupByLibrary.simpleMessage("Aristotle"),
    "author_dwayne_johnson": MessageLookupByLibrary.simpleMessage(
      "Dwayne Johnson",
    ),
    "author_james_clear": MessageLookupByLibrary.simpleMessage("James Clear"),
    "avg_time": MessageLookupByLibrary.simpleMessage("Thời gian trung bình"),
    "bad_suggestion_1": MessageLookupByLibrary.simpleMessage(
      "Có chút khó khăn",
    ),
    "bad_suggestion_2": MessageLookupByLibrary.simpleMessage("Cần cải thiện"),
    "best_time": MessageLookupByLibrary.simpleMessage(
    ...
    "cannot_generate_habit": MessageLookupByLibrary.simpleMessage(
      "Không thể tạo thói quen",
    ),
    "cannot_get_any_habit": MessageLookupByLibrary.simpleMessage(
      "Không thể lấy các thói quen",
    ),
    "cannot_get_any_history": MessageLookupByLibrary.simpleMessage(
      "Không thể lấy bất cứ lịch sử nào",
    ),
    "cannot_get_habit_with_name": m2,
    "cannot_store_history": MessageLookupByLibrary.simpleMessage(
    ...
    "category_distribution": MessageLookupByLibrary.simpleMessage(
    ...
    "community_challenges": MessageLookupByLibrary.simpleMessage(
      "Thử thách cộng đồng",
    ),
    "completed_progress": m4,
    "completion": m5,
    "completion_rate": MessageLookupByLibrary.simpleMessage("Tỉ lệ hoàn thành"),
    "compound_effect": MessageLookupByLibrary.simpleMessage(
      "Hiệu ứng Compound",
    ),
    ...
    "congratulation_title": MessageLookupByLibrary.simpleMessage("Chúc mừng"),
    "create_new_challenge": MessageLookupByLibrary.simpleMessage(
      "Tạo những thử thách mới",
    ),
    "current_distance": MessageLookupByLibrary.simpleMessage(
      "Quãng đường hiện tại",
    ),
    "current_progress": MessageLookupByLibrary.simpleMessage(
      "Tiến độ hiện tại",
    ),
    "current_streak": MessageLookupByLibrary.simpleMessage("Chuỗi hiện tại"),
    ...
    "daily_routine": MessageLookupByLibrary.simpleMessage("Lối sống hằng ngày"),
    ...
    "evening_greeting": MessageLookupByLibrary.simpleMessage("Chào buổi chiểu"),
    "every_n_day": m13,
    "every_n_hour": m14,
    "every_n_minute": m15,
    "every_n_month": m16,
    ...
    "exercise_habit_title": MessageLookupByLibrary.simpleMessage(
      "Tập thể dục buổi sáng",
    ),
    "exercise_reminder_title": MessageLookupByLibrary.simpleMessage(
      "Đến giờ tập thể dục",
    ),
    "failed": m17,
    "failed_habit": MessageLookupByLibrary.simpleMessage(
      "Các thói quen đã thất bại",
    ),
    "failed_rate": MessageLookupByLibrary.simpleMessage("Tỉ lệ thất bại"),
    "failed_statistic_page": MessageLookupByLibrary.simpleMessage("Thất bại"),
    "failed_title": MessageLookupByLibrary.simpleMessage("Thất bại:"),
    "failure_title": MessageLookupByLibrary.simpleMessage("Thất bại"),
    "fastest_time": MessageLookupByLibrary.simpleMessage(
      "Thời gian nhanh nhất",
    ),
    "find_button": MessageLookupByLibrary.simpleMessage("Tìm kiếm"),
    "first_achievement_title": MessageLookupByLibrary.simpleMessage(
      "Thành tựu đầu tiên",
    ),
    ...
    "generate_habit_button": MessageLookupByLibrary.simpleMessage(
      "Tạo thói quen",
    ),
    "get_preset_habit_option": MessageLookupByLibrary.simpleMessage(
      "Chọn các thói quen có sẵn",
    ),
    ...
    "goal_recommend_with_no_internet_alert": MessageLookupByLibrary.simpleMessage(
    ...
    "good_suggestion_1": MessageLookupByLibrary.simpleMessage("Tiến triển tốt"),
    "good_suggestion_2": MessageLookupByLibrary.simpleMessage(
      "Cảm giác hoàn thành tốt",
    ),
    "great_suggestion_1": MessageLookupByLibrary.simpleMessage("Bứt phá!"),
    "great_suggestion_2": MessageLookupByLibrary.simpleMessage(
      "Tốt nhất từ trước đến nay!",
    ),
    "habit_achieved_title": m18,
    "habit_category": MessageLookupByLibrary.simpleMessage("Loại thói quen"),
    "habit_category_creativity": MessageLookupByLibrary.simpleMessage(
      "Sáng tạo",
    ),
    "habit_category_education": MessageLookupByLibrary.simpleMessage("Học tập"),
    "habit_category_environmental": MessageLookupByLibrary.simpleMessage(
      "Môi trường",
    ),
    "habit_category_field_hint": MessageLookupByLibrary.simpleMessage(
      "Chọn loại thói quen",
    ),
    "habit_category_finance": MessageLookupByLibrary.simpleMessage("Tài chính"),
    "habit_category_health": MessageLookupByLibrary.simpleMessage("Sức khỏe"),
    "habit_category_lifestyle": MessageLookupByLibrary.simpleMessage(
      "Phong cách sống",
    ),
    "habit_category_mindfulness": MessageLookupByLibrary.simpleMessage(
      "Chánh niệm",
    ),
    "habit_category_nutrition": MessageLookupByLibrary.simpleMessage(
      "Dinh dưỡng",
    ),
    "habit_category_productivity": MessageLookupByLibrary.simpleMessage(
      "Năng suất",
    ),
    "habit_category_social": MessageLookupByLibrary.simpleMessage("Xã hội"),
    "habit_category_unknown": MessageLookupByLibrary.simpleMessage(
      "Không xác định",
    ),
    ...
    "habit_detail": MessageLookupByLibrary.simpleMessage("Chi tiết thói quen"),
    "habit_failed_title": m19,
    "habit_failure_reason_external_distractions":
        MessageLookupByLibrary.simpleMessage("Phân tâm bên ngoài"),
    "habit_failure_reason_forgetfulness": MessageLookupByLibrary.simpleMessage(
      "Hay quên",
    ),
    "habit_failure_reason_health_issues": MessageLookupByLibrary.simpleMessage(
      "Vấn đề sức khỏe",
    ),
    ...
    "habit_failure_reason_lack_of_time": MessageLookupByLibrary.simpleMessage(
      "Thiếu thời gian",
    ),
    "habit_failure_reason_other": MessageLookupByLibrary.simpleMessage("Khác"),
    "habit_failure_reason_procrastination":
        MessageLookupByLibrary.simpleMessage("Trì hoãn"),
    "habit_failure_reason_too_difficult": MessageLookupByLibrary.simpleMessage(
      "Quá khó khăn",
    ),
    "habit_failure_reason_unexpected_events":
        MessageLookupByLibrary.simpleMessage("Sự kiện bất ngờ"),
    "habit_failure_reason_unknown": MessageLookupByLibrary.simpleMessage(
      "Không xác định",
    ),
    "habit_frequency": MessageLookupByLibrary.simpleMessage("Tần suất"),
    "habit_generated_title": MessageLookupByLibrary.simpleMessage(
      "Thói quen chuẩn SMART",
    ),
    "habit_goal": MessageLookupByLibrary.simpleMessage("Mục tiêu thói quen"),
    "habit_name": MessageLookupByLibrary.simpleMessage("Tên thói quen"),
    "habit_pause_reason_health_issues": MessageLookupByLibrary.simpleMessage(
      "Vấn đề sức khỏe",
    ),
    "habit_pause_reason_lack_of_motivation":
        MessageLookupByLibrary.simpleMessage("Thiếu động lực"),
    "habit_pause_reason_lack_of_time": MessageLookupByLibrary.simpleMessage(
      "Thiếu thời gian",
    ),
    "habit_pause_reason_need_for_rest": MessageLookupByLibrary.simpleMessage(
      "Cần nghỉ ngơi",
    ),
    "habit_pause_reason_other": MessageLookupByLibrary.simpleMessage("Khác"),
    "habit_pause_reason_reassessment": MessageLookupByLibrary.simpleMessage(
      "Đánh giá lại",
    ),
    "habit_pause_reason_unexpected_events":
        MessageLookupByLibrary.simpleMessage("Sự kiện bất ngờ"),
    "habit_pause_reason_unknown": MessageLookupByLibrary.simpleMessage(
      "Không xác định",
    ),
    ...
    "habit_status_distribution": MessageLookupByLibrary.simpleMessage(
      "Phân bố theo trạng thái",
    ),
    "habits": m20,
    "health_and_sport": MessageLookupByLibrary.simpleMessage(
    ...
    "history_section": MessageLookupByLibrary.simpleMessage(
      "Lịch sử thực hiện",
    ),
    ...
    "in_progress_title": MessageLookupByLibrary.simpleMessage(
      "Đang tiến hành:",
    ),
    "inactive_button": MessageLookupByLibrary.simpleMessage("Không kích hoạt"),
    ...
    "know_more_about_habit": MessageLookupByLibrary.simpleMessage(
      "Hiểu về thói quen",
    ),
    ...
    "last_n_day": m23,
    "last_reminder_time": MessageLookupByLibrary.simpleMessage(
      "Nhắc nhở lần cuối",
    ),
    "latest_achievement_title": MessageLookupByLibrary.simpleMessage(
      "Thành tựu gần đây",
    ),
    ...
    "login_failure_title": MessageLookupByLibrary.simpleMessage(
      "Đăng nhập thất bại",
    ),
    ...
    "longest_streak": MessageLookupByLibrary.simpleMessage("Chuỗi dài nhất"),
    "longest_time": MessageLookupByLibrary.simpleMessage("Thời gian lâu nhất"),
    "m_unit": MessageLookupByLibrary.simpleMessage("m"),
    "manage_account_choice": MessageLookupByLibrary.simpleMessage(
      "Quản lý tài khoản",
    ),
    ...
    "measurable_negative_decline": MessageLookupByLibrary.simpleMessage(
      "suy giảm",
    ),
    "measurable_negative_decrease": MessageLookupByLibrary.simpleMessage(
      "giảm",
    ),
    "measurable_negative_diminish": MessageLookupByLibrary.simpleMessage(
      "giảm sút",
    ),
    "measurable_negative_fail": MessageLookupByLibrary.simpleMessage(
      "thất bại",
    ),
    "measurable_negative_lose": MessageLookupByLibrary.simpleMessage("mất"),
    "measurable_negative_revert": MessageLookupByLibrary.simpleMessage(
      "quay lại",
    ),
    "measurable_negative_weaken": MessageLookupByLibrary.simpleMessage(
      "yếu đi",
    ),
    ...
    "measurable_positive_accomplish": MessageLookupByLibrary.simpleMessage(
      "hoàn tất",
    ),
    "measurable_positive_achieve": MessageLookupByLibrary.simpleMessage(
      "đạt được",
    ),
    "measurable_positive_advance": MessageLookupByLibrary.simpleMessage(
      "tiến tới",
    ),
    "measurable_positive_attain": MessageLookupByLibrary.simpleMessage(
      "đạt tới",
    ),
    "measurable_positive_boost": MessageLookupByLibrary.simpleMessage(
      "tăng cường",
    ),
    "measurable_positive_build": MessageLookupByLibrary.simpleMessage(
      "xây dựng",
    ),
    "measurable_positive_complete": MessageLookupByLibrary.simpleMessage(
      "hoàn thành",
    ),
    "measurable_positive_cultivate": MessageLookupByLibrary.simpleMessage(
      "nuôi dưỡng",
    ),
    "measurable_positive_deliver": MessageLookupByLibrary.simpleMessage(
      "hoàn thành",
    ),
    "measurable_positive_develop": MessageLookupByLibrary.simpleMessage(
      "phát triển",
    ),
    "measurable_positive_enhance": MessageLookupByLibrary.simpleMessage(
      "nâng cao",
    ),
    "measurable_positive_expand": MessageLookupByLibrary.simpleMessage(
      "mở rộng",
    ),
    "measurable_positive_finalize": MessageLookupByLibrary.simpleMessage(
      "hoàn tất",
    ),
    "measurable_positive_finish": MessageLookupByLibrary.simpleMessage(
      "hoàn tất",
    ),
    "measurable_positive_growth": MessageLookupByLibrary.simpleMessage(
      "tăng trưởng",
    ),
    "measurable_positive_improve": MessageLookupByLibrary.simpleMessage(
      "cải thiện",
    ),
    "measurable_positive_increase": MessageLookupByLibrary.simpleMessage(
      "tăng",
    ),
    "measurable_positive_master": MessageLookupByLibrary.simpleMessage(
      "làm chủ",
    ),
    "measurable_positive_optimize": MessageLookupByLibrary.simpleMessage(
      "tối ưu hóa",
    ),
    "measurable_positive_perfect": MessageLookupByLibrary.simpleMessage(
      "hoàn thiện",
    ),
    "measurable_positive_progress": MessageLookupByLibrary.simpleMessage(
      "tiến bộ",
    ),
    "measurable_positive_raise": MessageLookupByLibrary.simpleMessage(
      "nâng lên",
    ),
    "measurable_positive_reach": MessageLookupByLibrary.simpleMessage(
      "đạt được",
    ),
    "measurable_positive_realize": MessageLookupByLibrary.simpleMessage(
      "thực hiện",
    ),
    "measurable_positive_refine": MessageLookupByLibrary.simpleMessage(
      "tinh chỉnh",
    ),
    "measurable_positive_strengthen": MessageLookupByLibrary.simpleMessage(
      "củng cố",
    ),
    "measurable_positive_succeed": MessageLookupByLibrary.simpleMessage(
      "thành công",
    ),
    ...
    "measurable_title": MessageLookupByLibrary.simpleMessage(
      "Đo lường - Measurable",
    ),
    ...
    "measurement_unit_title": MessageLookupByLibrary.simpleMessage(
      "Đơn vị đo lường",
    ),
    ...
    "meditation_habit_title": MessageLookupByLibrary.simpleMessage(
      "Thiền 5 phút",
    ),
    "meditation_reminder_title": MessageLookupByLibrary.simpleMessage(
      "Đến giờ thiền",
    ),
    "mental_health": MessageLookupByLibrary.simpleMessage("Sức khỏe tinh thần"),
    ...
    "monthly_process_section": MessageLookupByLibrary.simpleMessage(
      "Hằng tháng",
    ),
    "mood_bad": MessageLookupByLibrary.simpleMessage("Tệ"),
    "mood_distribution": MessageLookupByLibrary.simpleMessage(
      "Phân bố tâm trạng",
    ),
    ...
    "morning_greeting": MessageLookupByLibrary.simpleMessage("Chào buổi sáng"),
    ...
    "most_reason": MessageLookupByLibrary.simpleMessage("Nguyên nhân chủ yếu"),
    "my_custom_challenge_tab": MessageLookupByLibrary.simpleMessage(
      "Được tạo bởi tôi",
    ),
    "my_reward_tab": MessageLookupByLibrary.simpleMessage("Phần thưởng"),
    "neutral_suggestion_1": MessageLookupByLibrary.simpleMessage(
      "Hoàn thành theo kế hoạch",
    ),
    "neutral_suggestion_2": MessageLookupByLibrary.simpleMessage("Bình thường"),
    "next_habits_button": MessageLookupByLibrary.simpleMessage("Trang kế tiếp"),
    ...
    "no_date_selected": MessageLookupByLibrary.simpleMessage(
    ...
    "not_now_button": MessageLookupByLibrary.simpleMessage(
      "Không phải bây giờ",
    ),
    ...
    "notification_screen_title": MessageLookupByLibrary.simpleMessage(
      "Giữ vững thói quen của bạn!",
    ),
    "notifications": MessageLookupByLibrary.simpleMessage("Thông báo"),
    "notify_at": MessageLookupByLibrary.simpleMessage("Thông báo vào lúc: "),
    "on_your_way": m24,
    ...
    "overall_completion_rate": MessageLookupByLibrary.simpleMessage(
      "Tổng tỉ lệ hoàn thành",
    ),
    "overall_progress": m25,
    "page_unit": MessageLookupByLibrary.simpleMessage("trang"),
    "pareto_principle": MessageLookupByLibrary.simpleMessage("Quy luật Pareto"),
    ...
    "pause_tracking": MessageLookupByLibrary.simpleMessage("Tạm dừng theo dõi"),
    "paused": m27,
    "paused_at": m28,
    "paused_habit": MessageLookupByLibrary.simpleMessage(
      "Các thói quen đang tạm dừng",
    ),
    "paused_statistic_page": MessageLookupByLibrary.simpleMessage("Tạm ngưng"),
    ...
    "personal_achievements": MessageLookupByLibrary.simpleMessage(
      "Thành tựu cá nhân",
    ),
    "personal_info_section": MessageLookupByLibrary.simpleMessage(
      "Thông tin cá nhân",
    ),
    ...
    "power_of_timing": MessageLookupByLibrary.simpleMessage(
    ...
    "previous_habits_button": MessageLookupByLibrary.simpleMessage(
      "Trang trước đó",
    ),
    ...
    "psychology_cue_routine_reward": MessageLookupByLibrary.simpleMessage(
      "Cue-Routine-Reward",
    ),
    ...
    "quick_stats_title": MessageLookupByLibrary.simpleMessage(
      "Các thông số sơ bộ",
    ),
    ...
    "rate_and_note_completed_habit": MessageLookupByLibrary.simpleMessage(
      "Đánh giá và ghi chú",
    ),
    ...
    "reading_habit_title": MessageLookupByLibrary.simpleMessage(
      "Đọc 10 trang sách",
    ),
    "reading_reminder_title": MessageLookupByLibrary.simpleMessage(
      "Đến giờ đọc sách rồi",
    ),
    "recovery_description": MessageLookupByLibrary.simpleMessage(
      "Một mail xác nhận đã được gửi",
    ),
    "regenerate_button": MessageLookupByLibrary.simpleMessage(
      "Tạo thói quen khác",
    ),
    "relevant_accomplish": MessageLookupByLibrary.simpleMessage("hoàn thành"),
    ...
    "relevant_title": MessageLookupByLibrary.simpleMessage(
      "Thực tế - Relevant",
    ),
    ...
    "run_habit_title": MessageLookupByLibrary.simpleMessage("Đi/Chạy bộ 2km"),
    "run_reminder_title": MessageLookupByLibrary.simpleMessage(
      "Đến giờ tập chạy",
    ),
    "same_type_habit": MessageLookupByLibrary.simpleMessage(
      "Các thói quen cùng loại",
    ),
    "save_button": MessageLookupByLibrary.simpleMessage("Lưu"),
    "science_21_day_rule": MessageLookupByLibrary.simpleMessage(
      "Quy tắc 21 ngày",
    ),
    ...
    "science_dopamine_habits": MessageLookupByLibrary.simpleMessage(
      "Dopamine và Thói quen",
    ),
    ...
    "science_neuroplasticity": MessageLookupByLibrary.simpleMessage(
      "Neuroplasticity",
    ),
    ...
    "select_mood_title": MessageLookupByLibrary.simpleMessage(
      "Bạn đang cảm thấy như nào?",
    ),
    "select_range_date_title": MessageLookupByLibrary.simpleMessage(
      "Chọn ngày từ ... đến ...",
    ),
    ...
    "share_facebook_button": MessageLookupByLibrary.simpleMessage(
      "Chia sẻ đến facebook",
    ),
    "show_all_figure_button": MessageLookupByLibrary.simpleMessage(
    ...
    "society_and_family": MessageLookupByLibrary.simpleMessage(
      "Xã hội và gia đình",
    ),
    ...
    "specify_title": MessageLookupByLibrary.simpleMessage("Cụ thể - Specify"),
    "start_date": MessageLookupByLibrary.simpleMessage("Ngày bắt đầu"),
    "start_tracking": MessageLookupByLibrary.simpleMessage("Bắt đầu theo dõi"),
    "start_value_must_be_less_than_end": MessageLookupByLibrary.simpleMessage(
    ...
    "statistics_habit_formation_time": MessageLookupByLibrary.simpleMessage(
    ...
    "statistics_success_rate": MessageLookupByLibrary.simpleMessage(
      "Tỷ lệ thành công",
    ),
    ...
    "status_unknown": MessageLookupByLibrary.simpleMessage("Không xác định"),
    ...
    "store_image_to_device_button": MessageLookupByLibrary.simpleMessage(
      "Luư ảnh vào thiết bị",
    ),
    ...
    "study_habit_title": MessageLookupByLibrary.simpleMessage(
      "Học tập tập trung 2 tiếng",
    ),
    "study_reminder_title": MessageLookupByLibrary.simpleMessage("Đến giờ học"),
    ...
    "sync_data_title": MessageLookupByLibrary.simpleMessage("Đồng bộ"),
    "sync_failed": MessageLookupByLibrary.simpleMessage("Đồng bộ thất bại"),
    "sync_success": MessageLookupByLibrary.simpleMessage("Đồng bộ thành công"),
    ...
    "time_based_progress": MessageLookupByLibrary.simpleMessage(
    ...
    "time_bound_complete": MessageLookupByLibrary.simpleMessage("hoàn thành"),
    "time_bound_complete_by": MessageLookupByLibrary.simpleMessage(
      "hoàn thành bởi",
    ),
    ...
    "time_bound_duration": MessageLookupByLibrary.simpleMessage(
      "khoảng thời gian",
    ),
    "time_bound_end": MessageLookupByLibrary.simpleMessage("kết thúc"),
    "time_bound_end_by": MessageLookupByLibrary.simpleMessage("kết thúc bởi"),
    "time_bound_end_date": MessageLookupByLibrary.simpleMessage(
      "ngày kết thúc",
    ),
    ...
    "time_bound_immediate": MessageLookupByLibrary.simpleMessage(
      "ngay lập tức",
    ),
    "time_bound_in_the_next": MessageLookupByLibrary.simpleMessage(
      "trong vòng",
    ),
    ...
    "time_bound_promptly": MessageLookupByLibrary.simpleMessage("ngay tức thì"),
    "time_bound_quickly": MessageLookupByLibrary.simpleMessage("nhanh chóng"),
    ...
    "time_bound_soon_after": MessageLookupByLibrary.simpleMessage(
      "ngay sau khi",
    ),
    "time_bound_start": MessageLookupByLibrary.simpleMessage("bắt đầu"),
    "time_bound_start_by": MessageLookupByLibrary.simpleMessage("bắt đầu bởi"),
    "time_bound_start_from": MessageLookupByLibrary.simpleMessage("bắt đầu từ"),
    "time_bound_time_limit": MessageLookupByLibrary.simpleMessage(
      "giới hạn thời gian",
    ),
    "time_bound_timeframe": MessageLookupByLibrary.simpleMessage(
      "khung thời gian",
    ),
    "time_bound_timely": MessageLookupByLibrary.simpleMessage("kịp thời"),
    "time_bound_title": MessageLookupByLibrary.simpleMessage(
      "Thời gian - TimeBound",
    ),
    "time_bound_until": MessageLookupByLibrary.simpleMessage("đến khi"),
    "time_bound_upon_completion": MessageLookupByLibrary.simpleMessage(
      "sau khi hoàn thành",
    ),
    ...
    "time_bound_within_the_next": MessageLookupByLibrary.simpleMessage(
      "trong vòng",
    ),
    "time_interval": MessageLookupByLibrary.simpleMessage(
      "Các khoảng thời gian",
    ),
    "time_of_day_section": MessageLookupByLibrary.simpleMessage(
    ...
    "total_distance": MessageLookupByLibrary.simpleMessage("Tổng quãng đường"),
    "total_habit": MessageLookupByLibrary.simpleMessage("Tất cả các thói quen"),
    "total_paused_time": MessageLookupByLibrary.simpleMessage(
      "Tổng số thời gian tạm ngưng",
    ),
    "total_streak": m35,
    "tracker_section": MessageLookupByLibrary.simpleMessage("Theo dõi"),
    "trend_section": MessageLookupByLibrary.simpleMessage("Xu hướng"),
    "try_again": MessageLookupByLibrary.simpleMessage("Vui lòng thử lại sau"),
    "try_app_desc": m36,
    "try_app_now": MessageLookupByLibrary.simpleMessage(
      "Hãy thử ứng dụng ngay!",
    ),
    "unknown_exception": MessageLookupByLibrary.simpleMessage(
      "Đã xảy ra lỗi không xác định.",
    ),
    "update_failure_title": MessageLookupByLibrary.simpleMessage(
      "Cập nhật thất bại",
    ),
    "update_success_title": MessageLookupByLibrary.simpleMessage(
      "Cập nhật thành công",
    ),
    ...
    "water_habit_title": MessageLookupByLibrary.simpleMessage(
      "Uống đủ 2L nước mỗi ngày",
    ),
    "water_reminder_title": MessageLookupByLibrary.simpleMessage(
      "Đến lúc uống nước",
    ),
    "weak_password": MessageLookupByLibrary.simpleMessage(
      "Vui lòng nhập mật khẩu mạnh hơn.",
    ),
    "weekday_title": MessageLookupByLibrary.simpleMessage(
      "Các ngày trong tuần",
    ),
    "weekly_completion_rate": MessageLookupByLibrary.simpleMessage(
      "Tỉ lệ hoàn thành theo tuần",
    ),
    "weekly_mood": MessageLookupByLibrary.simpleMessage("Tâm trạng trong tuần"),
    "weekly_process_section": MessageLookupByLibrary.simpleMessage("Hằng tuần"),
