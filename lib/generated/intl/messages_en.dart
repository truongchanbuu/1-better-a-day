...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m22(count) => "Remove ${count}ssucML";

  static String m23(score) =>
  ...
  static String m26(count) => "Total: ${count}";
